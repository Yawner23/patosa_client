                ...
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-white" href="tel:+1 (555) 234-5678">09453426009</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a class="hover:text-white" href="mailto:hello@example.com">secretpeak@gmail.com</a></dd>
                        </div>
                    </dl>
                </div>
            </div>
