<template>
    <div class="lg:flex lg:h-full lg:flex-col bg-black">
        ...
        <div class="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col">
            <div
                class="grid grid-cols-7 gap-px border-b border-gray-300 bg-gray-200 text-center text-xs font-semibold leading-6 text-white lg:flex-none">
                <div class="bg-black py-2">M<span class="sr-only sm:not-sr-only">on</span></div>
                <div class="bg-black py-2">T<span class="sr-only sm:not-sr-only">ue</span></div>
                <div class="bg-black py-2">W<span class="sr-only sm:not-sr-only">ed</span></div>
                <div class="bg-black py-2">T<span class="sr-only sm:not-sr-only">hu</span></div>
                <div class="bg-black py-2">F<span class="sr-only sm:not-sr-only">ri</span></div>
                <div class="bg-black py-2">S<span class="sr-only sm:not-sr-only">at</span></div>
                <div class="bg-black py-2">S<span class="sr-only sm:not-sr-only">un</span></div>
            </div>
...
const days = [
    ...
    { date: '2022-01-02', isCurrentMonth: true, events: [] },
    {
        ...
        isCurrentMonth: true,
        events: [
            { id: 1, name: 'Battle of the Bands', time: '10AM', datetime: '2022-01-03T10:00', href: '#' },
        ],
    },
    ...
    { date: '2022-01-11', isCurrentMonth: true, events: [] },
    {
        ...
        isCurrentMonth: true,
        isToday: true,
        events: [{ id: 6, name: "Wedding Event", time: '2PM', datetime: '2022-01-25T14:00', href: '#' }],
    },
